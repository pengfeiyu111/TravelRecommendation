...
<div id="home">
    <div id="header" class="header">
        ...
        <div class="rightBox">
            ...
            <div class="shu"></div>
            <div class="white current">旅游攻略</div>
    ...
    <header>
        ...
        <div class="search">
            <input class="searchInput" id="zwzSearchPositionInput" type="text" placeholder="搜索旅游景点名称...">
            <button class="searchBt" @click="selectPositionByTitleFx">搜索</button>
        </div>
        <div :class="class1">
            <input class="searchInput" type="text" placeholder="搜索旅游景点名称..." style="boxShadow:none;borderColor:#EFF1F1;">
    ...
    <div class="body">
        <div class="main">
            <div class="mainBox">
                <div class="mainTitle">景点交通指南 （{{newList.length}}）</div>
                    ...
                    <el-col :span="24">
                        <el-row :gutter="20">
                            ...
                            <el-col :span="18">
                                ...
                                <el-row :gutter="20" class="spanContext">
                                    <span class="spanContextLabel"> 起点：</span>{{item.start}}
                                </el-row>
                                <el-row :gutter="20" class="spanContext">
                                    <span class="spanContextLabel"> 终点：</span>{{item.end}}
                                </el-row>
                                <el-row :gutter="20" class="spanContext">
                                    <span class="spanContextLabel"> 交通方式：</span>{{item.way}}
                                </el-row>
                                <el-row :gutter="20" class="spanContext">
                                    <span class="spanContextLabel"> 行程路线：</span>{{item.content}}
                                </el-row>
                            </el-col>
                        </el-row>
                    </el-col>
                </el-row>
                <div class="mainTitle">景点周边美食推荐 （{{newList2.length}}）</div>
                <el-row :gutter="20" v-for="(item,index) in newList2" :key="index" @click="toCarsItemPage(item)" style="width: 100%;margin-bottom: 10px;">
                    <el-col :span="24">
                        <el-row :gutter="20">
                            ...
                            <el-col :span="18">
                                <el-row :gutter="20" class="spanContext2">
                                    <span class="spanContextLabel2"> 景点名称：</span>{{item.spotName}}
                                </el-row>
                                <el-row :gutter="20" class="spanContext2">
                                    <span class="spanContextLabel2"> 美食类型：</span>{{item.type}}
                                </el-row>
                                <el-row :gutter="20" class="spanContext2">
                                    <span class="spanContextLabel2"> 人均消费：</span>{{item.avg}}
                                </el-row>
                                <el-row :gutter="20" class="spanContext2">
                                    <span class="spanContextLabel2"> 美食简介：</span>{{item.content}}
                                </el-row>
                            </el-col>
                        </el-row>
                    </el-col>
                ...
                <!-- <div class="box" v-for="(item,index) in newList" :key="index">
                    <span class="name">【{{item.spotName}}】{{ item.title }}</span>
                    <div class="labelBox">
                        <span>起点：{{item.start}}</span>
                    </div>
                    <div class="labelBox">
                        <span>终点：{{item.end}}</span>
                    </div>
                    <div class="labelBox">
                        <span>交通方式：{{item.way}}</span>
                    </div>
                    <div class="labelBox">
                        <span>行程路线：{{item.content}}</span>
                    </div>
                    <div style="display:inline">
                        <img :src="item.imageUrl" style="height:300px;width:auto" />
                    </div>
                </div> -->
            </div>
        </div>
