...
<div id="home">
    ...
    <div class="body">
        <div class="main">
            <div class="mainBox">
                <div class="mainTitle">预约单详情页</div>
                <div class="box">
                    ...
                    <div class="labelBox">
                        ...
                        <div class="smallShu"></div>
                        <el-button type="success" @click="deleteLookFx(item)">取消预约</el-button>
                    </div>
                    <div class="labelBox">
                        旅游景点品牌: {{item.brand}}
                    </div>
...
export default {
    ...
    methods: {
        ...
        getOneLookFx() {
            var that = this;
            getOneLook({id: that.getStore("lookId")}).then(res => {
                if(res.data.success) {
