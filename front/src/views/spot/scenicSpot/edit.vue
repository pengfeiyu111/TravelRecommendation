    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="评分" prop="star">
                <InputNumber v-model="form.star" readonly style="width:570px"></InputNumber>
            </FormItem>
            <FormItem label="收藏量" prop="collection">
                <InputNumber v-model="form.collection" readonly style="width:570px"></InputNumber>
            </FormItem>
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    editScenicSpot(this.form).then(res => {
