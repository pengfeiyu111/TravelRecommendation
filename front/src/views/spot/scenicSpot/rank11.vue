        ...
        getTopCollectionFx() {
            ...
            getTopCollection().then(res => {
                ...
                if (res.success) {
                    ...
                    that.maxMoney = res.result[3].collection;
                    var arr = [];
