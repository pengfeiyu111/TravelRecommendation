            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="status">
                        <dict dict="spot_type_status" v-model="searchForm.status" transfer clearable placeholder="类型状态..." style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getScenicSpotTypeList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
