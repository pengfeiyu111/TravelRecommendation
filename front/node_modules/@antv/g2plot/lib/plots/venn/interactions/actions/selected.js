...
var ElementSelectedAction = g2_1.getActionClass('element-selected');
var ElementSingleSelectedAction = g2_1.getActionClass('element-single-selected');
/**
 * 韦恩图元素 多选交互
 */
var VennElementSelected = /** @class */ (function (_super) {
    ...
    VennElementSelected.prototype.syncElementsPos = function () {
        util_1.placeElementsOrdered(this.context.view);
    };
    /** 激活图形元素 */
