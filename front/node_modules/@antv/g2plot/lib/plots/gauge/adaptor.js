...
function tooltip(params) {
    ...
    if (tooltip) {
        chart.tooltip(utils_1.deepAssign({
            showTitle: false,
            showMarkers: false,
            ...
            customContent: function (x, data) {
                var percent = util_1.get(data, [0, 'data', constants_1.PERCENT], 0);
...
function adaptor(params) {
    ...
    common_1.animation, geometry, meta, tooltip, statistic, common_1.interaction, common_1.annotation(), other
    // ... 其他的 adaptor flow
    )(params);
}
